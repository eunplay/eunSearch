...
open class BasisActivity : AppCompatActivity() {
    ...
    fun showDialog(msg: String) {
        ...
        mBuilder.setTitle(R.string.message_notification).setMessage(msg)
    ...
    fun showProgressDialog() {
        ...
        val mBuilder =
            AlertDialog.Builder(ContextThemeWrapper(this , R.style.SpinnerProgressDialog))
