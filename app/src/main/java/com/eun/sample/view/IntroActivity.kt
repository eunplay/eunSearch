...
class IntroActivity : BasisActivity() {
    ...
    private fun showDialog(
        ...
        mBuilder.setTitle(R.string.message_notification)
        mBuilder.setMessage(msg)
        mBuilder.setCancelable(false)

        if (positiveListener != null) {
            mBuilder.setPositiveButton(positiveText , positiveListener)
        }
        if (negativeListener != null) {
            mBuilder.setNegativeButton(negativeText , negativeListener)
        }
